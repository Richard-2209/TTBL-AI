...
CREATE TABLE IF NOT EXISTS Seasons (
    id INT PRIMARY KEY AUTO_INCREMENT,
    name VARCHAR(50) NOT NULL  -- z.B. "2018/19"
);
...
CREATE TABLE IF NOT EXISTS SeasonResults (
    ...
    UNIQUE (season_id, team_id) -- ein Team pro Saison nur einmal
);
-- INSERT INTO SeasonResults (season_id, team_id, position, wins, draws, losses, points)
